...
const Game = () => {
  ...
  const addBall = useCallback(
    (ballValue: number) => {
      ...
      console.log("Adding ball at:", ballX, 20, "with value:", ballValue);
  ...
  multipliers.forEach((multiplier) => {
    const blockSize = 40; // height and width
  ...
  return (
    <div className="h-[90dvh] overflow-y-hidden max-h-full flex-col rounded-2xl py-4 bg-[#14171F]">
      <div className="w-full flex items-center justify-between h-full">
        ...
        <div className="w-[35%] bg-[#1A1D29] m-5 rounded-2xl p-5 h-full">
